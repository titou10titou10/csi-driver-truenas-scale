...
### install 
```console
helm upgrade -i tns.csi.titou10.org -f <your values.yaml> oci://ghcr.io/titou10titou10/tns-csi-driver:v0.1.0
```

## uninstall CSI driver
```console
helm uninstall tns.csi.titou10.org -n kube-system
```
...
| `image.tnsplugin.tag`              | Tag for the CSI plugin image            | `v0.1.0`                                      |
